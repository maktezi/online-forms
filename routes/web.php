...
Route::middleware(['process_request'])->group(function () {
    Route::get('/', function () {
        return view('index');
    });
    ...
    Route::get('/addsaln', [SalnController::class, 'add'])->name('add.saln');
    Route::get('/editsaln/{id}', [SalnController::class, 'edit'])->name('edit.saln');
    Route::post('/form_saln', [SalnController::class, 'store'])->name('store.saln');
    Route::post('/update_saln/{id}', [SalnController::class, 'update'])->name('update.saln');
    Route::get('/delete_saln/{id}', [SalnController::class, 'delete'])->name('delete.saln');
    Route::get('/view_saln/{id}', [SalnController::class, 'viewpdf'])->name('view.saln');
    ...
    Route::middleware(['check_admin_access'])->group(function () {
        ...
        Route::get('/saln_admin', [SalnController::class, 'admin'])->name('saln.admin');
